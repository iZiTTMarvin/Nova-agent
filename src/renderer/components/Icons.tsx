...
/** 文件夹图标 - 工作区选择 */
export const FolderIcon: React.FC<IconProps> = ({ size = 20, ...props }) => (
...
/** 停止图标 - 取消 Agent 响应生成 */
export const StopIcon: React.FC<IconProps> = ({ size = 18, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const ChevronIcon: React.FC<IconProps & { direction?: 'up' | 'down' | 'right' }> = ({ size = 16, direction = 'down', ...props }) => {
  ...
  return (
    <svg 
      ...
      style={{ transform: getRotation(), transition: 'transform 0.2s ease', ...props.style }}
      {...props}
    >
...
/** 盾牌图标 - 会话权限模式 */
export const ShieldIcon: React.FC<IconProps> = ({ size = 16, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
/** 指南针图标 - 分析模式 (Plan) */
export const CompassIcon: React.FC<IconProps> = ({ size = 16, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <circle cx="12" cy="12" r="10" />
...
/** 协同握手/气泡图标 - 协同模式 (Default) */
export const UserCheckIcon: React.FC<IconProps> = ({ size = 16, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
/** 回退图标 - 消息回退 */
export const UndoIcon: React.FC<IconProps> = ({ size = 16, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M3 7v6h6" />
...
export const RestoreIcon: React.FC<IconProps> = ({ size = 16, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M4 8v10a2 2 0 0 0 2 2h10" fill="none" />
  </svg>
)

/** 加载旋转图标 — 流式写入卡片 running 状态 */
...
/** 复制图标 - Markdown 代码块右上角 */
export const CopyIcon: React.FC<IconProps> = ({ size = 14, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
/** 图片图标 - 图片上传 */
export const ImageIcon: React.FC<IconProps> = ({ size = 18, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <rect x="3" y="3" width="18" height="18" rx="2" ry="2" />
...
/** 左侧面板图标 - 会话导航折叠开关 */
export const PanelLeftIcon: React.FC<IconProps> = ({ size = 16, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
/** 右侧面板图标 - inspector 开关 */
export const PanelRightIcon: React.FC<IconProps> = ({ size = 16, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <rect x="3" y="3" width="18" height="18" rx="2" />
...
/** 地球图标 - 在 Nova 中打开网页 */
export const GlobeIcon: React.FC<IconProps> = ({ size = 16, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <circle cx="12" cy="12" r="10" />
...
/** 芯片/模型图标 - 模型配置设置 */
export const CpuIcon: React.FC<IconProps> = ({ size = 16, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
/** 记忆/大脑图标 */
export const BrainIcon: React.FC<IconProps> = ({ size = 16, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
/** 规则/卷轴图标 */
export const ScrollIcon: React.FC<IconProps> = ({ size = 16, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
/** 技能/拼图图标 */
export const PuzzleIcon: React.FC<IconProps> = ({ size = 16, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M19 13.5a2.5 2.5 0 0 1 2.5 2.5v2a2 2 0 0 1-2 2h-2a2.5 2.5 0 0 1-5 0H8a2 2 0 0 1-2-2v-2a2.5 2.5 0 0 1 0-5V8a2 2 0 0 1 2-2h2a2.5 2.5 0 0 1 5 0h2a2 2 0 0 1 2 2v2a2.5 2.5 0 0 1-2.5 2.5" />
  </svg>
)

/** 代码索引/结构树图标 */
export const CodeIndexIcon: React.FC<IconProps> = ({ size = 16, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <polyline points="16 18 22 12 16 6" />
    <polyline points="8 6 2 12 8 18" />
...
/** 滑块/定制图标 - Customize */
export const SlidersIcon: React.FC<IconProps> = ({ size = 16, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
